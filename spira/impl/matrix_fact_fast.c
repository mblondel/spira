/* Generated by Cython 0.20.1 on Fri Jan 16 00:27:11 2015 */
...
static PyObject *__pyx_pw_5spira_4impl_16matrix_fact_fast_1_cd_fit(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_5spira_4impl_16matrix_fact_fast__cd_fit(__pyx_self, __pyx_v_self, __pyx_v_X_data, __pyx_v_X_indices, __pyx_v_X_indptr, __pyx_v_P, __pyx_v_Q, __pyx_v_residuals, __pyx_v_g, __pyx_v_h, __pyx_v_delta, __pyx_v_n_components, __pyx_v_alpha, __pyx_v_max_iter, __pyx_v_tol, __pyx_v_callback, __pyx_v_verbose);
...
static PyObject *__pyx_pf_5spira_4impl_16matrix_fact_fast__cd_fit(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyArrayObject *__pyx_v_X_data, PyArrayObject *__pyx_v_X_indices, PyArrayObject *__pyx_v_X_indptr, PyArrayObject *__pyx_v_P, PyArrayObject *__pyx_v_Q, PyArrayObject *__pyx_v_residuals, PyArrayObject *__pyx_v_g, PyArrayObject *__pyx_v_h, PyArrayObject *__pyx_v_delta, int __pyx_v_n_components, double __pyx_v_alpha, int __pyx_v_max_iter, double __pyx_v_tol, PyObject *__pyx_v_callback, int __pyx_v_verbose) {
  ...
  /* "spira/impl/matrix_fact_fast.pyx":130
 * 
 *     cdef int n, it
 ...
 */
  ...
  /* "spira/impl/matrix_fact_fast.pyx":137
 *     cdef int n_cols = Q.shape[1]
 * 
 *     cdef double* P_ptr = <double*>P.data             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "spira/impl/matrix_fact_fast.pyx":146
 * 
 *     # Estimate P and Q
 ...
 */
  ...
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_3; __pyx_t_6+=1) {
    ...
    /* "spira/impl/matrix_fact_fast.pyx":147
 *     # Estimate P and Q
 *     for it in xrange(max_iter):
 *         violation = 0;             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "spira/impl/matrix_fact_fast.pyx":149
 *         violation = 0;
 * 
 *         violation += _cd(X_data, X_indices, X_indptr, P_ptr, Q_ptr, residuals,             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "spira/impl/matrix_fact_fast.pyx":157
 * 
 *         if has_callback:
 *             callback(self)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_8 = __Pyx_PyObject_Call(__pyx_v_callback, __pyx_t_7, NULL); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
    ...
    /* "spira/impl/matrix_fact_fast.pyx":162
 *             violation_init = violation;
 * 
 *         if verbose:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "spira/impl/matrix_fact_fast.pyx":163
 * 
 *         if verbose:
 *             print it + 1, violation / violation_init             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_8 = __Pyx_PyInt_From_long((__pyx_v_it + 1)); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_7 = PyFloat_FromDouble((__pyx_v_violation / __pyx_v_violation_init)); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
    ...
    /* "spira/impl/matrix_fact_fast.pyx":165
 *             print it + 1, violation / violation_init
 * 
 *         if violation / violation_init < tol:             # <<<<<<<<<<<<<<
 *             if verbose:
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "spira/impl/matrix_fact_fast.pyx":166
 * 
 *         if violation / violation_init < tol:
 *             if verbose:             # <<<<<<<<<<<<<<
 *                 print "Converged"
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "spira/impl/matrix_fact_fast.pyx":167
 *         if violation / violation_init < tol:
 *             if verbose:
 *                 print "Converged"             # <<<<<<<<<<<<<<
 *             break
 ...
 */
      ...
      /* "spira/impl/matrix_fact_fast.pyx":168
 *             if verbose:
 *                 print "Converged"
 *             break             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pf_5spira_4impl_16matrix_fact_fast_2_predict(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_X_data, PyArrayObject *__pyx_v_X_indices, PyArrayObject *__pyx_v_X_indptr, PyArrayObject *__pyx_v_P, PyArrayObject *__pyx_v_Q) {
  ...
  /* "spira/impl/matrix_fact_fast.pyx":177
 ...
 */
  ...
  /* "spira/impl/matrix_fact_fast.pyx":178
 * 
 *     cdef int n_rows = P.shape[0]
 *     cdef int n_components = P.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "spira/impl/matrix_fact_fast.pyx":187
 *     cdef double dot
 * 
 *     for u in xrange(n_rows):             # <<<<<<<<<<<<<<
 *         n_nz = X_indptr[u+1] - X_indptr[u]
 ...
 */
    ...
    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      ...
      /* "spira/impl/matrix_fact_fast.pyx":193
 * 
 *         for ii in xrange(n_nz):
 *             i = indices[ii]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "spira/impl/matrix_fact_fast.pyx":195
 *             i = indices[ii]
 * 
 *             dot = 0             # <<<<<<<<<<<<<<
 *             for k in xrange(n_components):
 ...
 */
      ...
      /* "spira/impl/matrix_fact_fast.pyx":196
 * 
 *             dot = 0
 *             for k in xrange(n_components):             # <<<<<<<<<<<<<<
 *                 dot += P[u, k] * Q[k, i]
 ...
 */
      ...
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        ...
        /* "spira/impl/matrix_fact_fast.pyx":197
 *             dot = 0
 *             for k in xrange(n_components):
 *                 dot += P[u, k] * Q[k, i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "spira/impl/matrix_fact_fast.pyx":199
 *                 dot += P[u, k] * Q[k, i]
 * 
 *             data[ii] = dot             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __pyx_codeobj__10 = (PyObject*)__Pyx_PyCode_New(5, 0, 15, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__9, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_mblondel_Desktop_projects, __pyx_n_s_predict, 171, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 171; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *              np.ndarray[int, ndim=1] X_indptr,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5spira_4impl_16matrix_fact_fast_3_predict, NULL, __pyx_n_s_spira_impl_matrix_fact_fast); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 171; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
